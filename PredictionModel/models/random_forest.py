...
class MyRandomForest:
    # manually implements forest with random data sampling forcing tree
    # to find different patterns in data
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_trees):
            ...
            feature_indices = np.random.choice(
                n_features, n_subset, replace=False
                )
...
def analyze_feature_importance(forest, feature_names):
    # rough estimate of feature importance
